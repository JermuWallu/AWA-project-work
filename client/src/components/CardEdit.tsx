...
const colorOptions = [
  '#ffffff', '#f87171', '#fbbf24', '#34d399', '#60a5fa', '#a78bfa', '#f472b6', '#d1d5db'
];

export default function CardEdit({ cardId, initialTitle, initialText, initialColor, onClose, onSave }: CardEditProps) {
  ...
  const handleSave = async () => {
    try {
      ...
      await axios.put(`http://localhost:1234/api/card/${cardId}`,
        { title, text, color },
